...
from ShearMyLifeAgain import MemberDes
...
while abs(M - M_old) > 10:
    ...
    Rt = R * 10**3
    mAttatch = MemberDes(rho, sigma_y_b, tau_y_b, M, Rs, Rt)[1]
    D0 = MemberDes(rho, sigma_y_b, tau_y_b, M, Rs, Rt)[0]*2*10**(-3)
    D_M = abs(M-M_old)
